...
vim.keymap.set('n', 'K', ':bnext<CR>', { desc = 'Press K to move to the next buffer' })
vim.keymap.set('n', 'J', ':bprevious<CR>', { desc = 'Press J to move to the previous buffer' })
vim.keymap.set('n', '<Leader>w', '<C-o>:bd #<CR>', { desc = 'Press "' .. vim.g.mapleader .. '" + w to delete the current buffer' })
