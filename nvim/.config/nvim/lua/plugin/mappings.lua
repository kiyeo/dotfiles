...
function M.lsp_format()
  vim.keymap.set('n', '<Leader>F', ':lua vim.lsp.buf.formatting()<CR>', { desc = 'lsp-format.nvim - Press "' .. vim.g.mapleader .. '" + F to format file' })
end
...
function M.nvim_dap()
  ...
  vim.keymap.set('n', '<Leader>dlp', function() dap.set_breakpoint(nil, nil, vim.fn.input("Log point message: ")) end, { desc = 'nvim-dap - Press "' .. vim.g.mapleader .. '" + l + p to log message and set_breakpoint.' })
